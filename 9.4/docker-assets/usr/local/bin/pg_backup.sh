#!/bin/bash
# Postgres backup script adapted from https://wiki.postgresql.org/wiki/Automated_Backup_on_Linux
...
# Use IS8601 Date + Time 
FINAL_BACKUP_DIR=$BACKUP_DIR"`date +%Y-%m-%dT%H_%M_%SZ`/"
